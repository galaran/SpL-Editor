...
public class Tag {
    ...
    public Tag getTagByName(String name) throws TagNotFoundException {
        Tag found = findTagByName(name);
        if (found == null) throw new TagNotFoundException(name + " in " + this.name);
        return found;
    }
    ...
    public class TagNotFoundException extends Exception {
        ...
        private TagNotFoundException(String string) {
            super(string);
        }
 }
}
